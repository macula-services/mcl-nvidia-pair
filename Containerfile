...
LABEL org.opencontainers.image.source="https://github.com/macula-services/mcl-nvidia-pair"
...
WORKDIR /app
COPY --from=builder /build/_build/prod/rel/mcl_nvidia_pair ./

ENV HOME=/app
ENV RELX_REPLACE_OS_VARS=true

ENV MCL_NODE_NAME=mcl_nvidia_pair
ENV MCL_NODE_HOST=127.0.0.1
ENV MCL_COOKIE=mcl_nvidia_pair
ENV MCL_HEALTH_PORT=8499
...
CMD ["/app/bin/mcl_nvidia_pair", "foreground"]
